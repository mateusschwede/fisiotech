<?php require_once 'extras/start.php' ?>
INDEX DO FISIOTERAPEUTA
<br>
- Ver sessões fisioterapia(filtro por dia)<br>
- Cadastrar sessão fisioterapia<br>
- Editar sessão fisioterapia<br>
- Realizar sessão fisioterapia<br>
- Cancelar sessão fisioterapia<br>
